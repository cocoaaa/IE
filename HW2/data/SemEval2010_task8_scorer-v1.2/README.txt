...
Use:
   perl semeval2010_task8_format_checker.pl <PROPOSED_ANSWERS>

Examples:
   perl semeval2010_task8_format_checker.pl proposed_answer1.txt
   perl semeval2010_task8_format_checker.pl proposed_answer2.txt
   perl semeval2010_task8_format_checker.pl proposed_answer3.txt
   perl semeval2010_task8_format_checker.pl proposed_answer4.txt
   perl semeval2010_task8_format_checker.pl proposed_answer5.txt
...
Examples:
   perl semeval2010_task8_scorer-v1.2.pl proposed_answer1.txt answer_key1.txt > result_scores1.txt
   perl semeval2010_task8_scorer-v1.2.pl proposed_answer2.txt answer_key2.txt > result_scores2.txt
   perl semeval2010_task8_scorer-v1.2.pl proposed_answer3.txt answer_key3.txt > result_scores3.txt
   perl semeval2010_task8_scorer-v1.2.pl proposed_answer5.txt answer_key5.txt > result_scores5.txt
